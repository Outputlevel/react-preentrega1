...
import { getWishlist } from '../../Services/moks/wishlist';
...
const WishlistWidget = () => {
    ...
    return (
        <div style={{cursor: 'pointer'}}>
            ...
            <span className='cart-icon-number'>{wishlists.lenght}</span>
            {wishlists.map(liked => {
                return (
                    <span className='cart-icon-number'>{liked.id}</span>
            )
            })}
